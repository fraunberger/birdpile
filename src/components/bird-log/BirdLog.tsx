...
const CATEGORY_CONFIGS: Record<string, CategoryConfig> = {
  movie: { label: 'Movie', titleLabel: 'Film Title', subtitleLabel: 'Director', icon: '' },
  tv: { label: 'TV Show', titleLabel: 'Show Name', subtitleLabel: 'Season/Ep', icon: '' },
  music: { label: 'Music', titleLabel: 'Song/Album', subtitleLabel: 'Artist', icon: '' },
  restaurant: { label: 'Restaurant', titleLabel: 'Place Name', subtitleLabel: 'Dish', icon: '' },
  beer: { label: 'Beer', titleLabel: 'Drink Name', subtitleLabel: 'Brewery/Type', icon: '' },
  cooking: { label: 'Recipe', titleLabel: 'Dish Name', subtitleLabel: 'Ingredients', icon: '' },
  podcast: { label: 'Podcast', titleLabel: 'Episode Title', subtitleLabel: 'Podcast Name', icon: '' },
  book: { label: 'Book', titleLabel: 'Book Title', subtitleLabel: 'Author', icon: '' },
};
